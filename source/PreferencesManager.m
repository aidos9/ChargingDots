...
+ (void)setValue:(id)value forKey:(NSString*)key {
  ...
  NSDictionary* bundleDefaults =
      [[NSUserDefaults standardUserDefaults] persistentDomainForName:DOMAIN_NAME];
...
+ (void)resetSettings {
  // For bools, ints and floats we have to convert to an NSNumber because the NSUserDefaults
  // requires an NSObject derived object.
  ...
  [PreferencesManager setValue:[NSNumber numberWithInt:DEFAULT_NUMBER_OF_DOTS]
                        forKey:@"numberOfDots"];
  [PreferencesManager setValue:[NSNumber numberWithBool:DEFAULT_SHOW_ALL_TIME]
                        forKey:@"showAllTime"];
  [PreferencesManager setValue:[NSNumber numberWithBool:DEFAULT_HAS_CHARGING_COLOR]
                        forKey:@"hasChargingColor"];
  [PreferencesManager setValue:[NSNumber numberWithBool:DEFAULT_LOW_POWER_ENABLED]
                        forKey:@"lowPowerColorEnabled"];
  [PreferencesManager setValue:[NSNumber numberWithBool:DEFAULT_PULSE_CHARGING_COLOR]
                        forKey:@"pulseChargingColor"];
  ...
  [PreferencesManager setValue:[NSNumber numberWithBool:DEFAULT_Y_OFFSET_ENABLED]
                        forKey:@"yOffsetEnabled"];
  [PreferencesManager setValue:[NSNumber numberWithBool:DEFAULT_X_OFFSET_ENABLED]
                        forKey:@"xOffsetEnabled"];
  [PreferencesManager setValue:[NSNumber numberWithFloat:DEFAULT_PARENT_VIEW_LENGTH]
                        forKey:@"parentViewLength"];
  ...
  [PreferencesManager setValue:[NSNumber numberWithBool:DEFAULT_HIDE_DATE_LABEL]
                        forKey:@"hideDateLabel"];
...
+ (float)parentViewLength {
  ...
  if (value == nil) {
    // This is a check because in previous versions before we added the vertical orientation so if
    // the user was on that beta then we move their value across to this new key for the new
    // version.
