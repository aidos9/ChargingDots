...
#define DEFAULT_LOW_BATTERY_PERCENTAGE 0.2f // The value at which the low battery color should be shown
...
#define DEFAULT_BORDER_THICKNESS 1.0f
#define DEFAULT_BORDER_COLOR @"00000000" // Clear
